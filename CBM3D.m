...
%     zRGB=im2double(imread('elsa2_add_noise.png'));
...
% Check if the true image yRGB is a valid one; if not, then we cannot compute , etc.
...
imwrite(yRGB_est,'48_bm3d.png');
imwrite(uint8(yRGB_est),'48_bm3d_uint8.png');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
